                ...
                <li>
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            <ul class="ad-item-list">
                                <li class="J_menuItem" href="2-1recommand.php" data-index="1">热门推荐</li>
                                <li class="J_menuItem" href="2-2search.php" data-index="2">图书搜索</li>
                            </ul>
                        </dd>
                        <dd>
                            <a href="#" class="dd-item">借还操作<span class="scm dd-ar"></span></a>
                            <ul class="ad-item-list">
                                <li class="J_menuItem" href="3-1borrowBook.php" data-index="1">借书</li>
                                <li class="J_menuItem" href="3-2returnBook.php" data-index="2">还书</li>
                            </ul>
                        </dd>
                        <dd>
                            <a href="#" class="dd-item">借书证管理<span class="scm dd-ar"></span></a>
                            <ul class="ad-item-list">
                                <li class="J_menuItem" href="4-1addCard.php" data-index="1">增加借书证</li>
                                <li class="J_menuItem" href="4-2deleteCard.php" data-index="2">删除借书证</li>
                            </ul>
                        </dd>
                    </dl>
                </li>
                ...
                <div class="ad-top-right">
                    <div class="ad-welcom">
                        <div class="ad-wel-text">
                            <div class="font-wel">欢迎您！<strong><?php $username = $_SESSION['name'];echo $username;?></strong></div>
                            <div class="font-wel"><a href="index.php"><strong>【退出】</strong></a></div>
                        </div>
                    </div>
                </div>
            </div>
